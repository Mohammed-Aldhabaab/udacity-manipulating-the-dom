...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
* @description Tracking progress bar
*/
const trackProgressBar = () => {
    let progress = window.pageYOffset / window.innerHeight * 100;
    header.style.setProperty('--progress__bar__width', progress + '%');
}
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
* @description Return boollean if element is in the middle of the viewport (A distance of a half above and below it)
...
* @param {number} prevScrollpos
*/
const scrollToTopButton = (prevScrollpos) => {
    prevScrollpos > 100 ?
...
window.onscroll = () => {
    ...
    scrollToTopButton(prevScrollpos);
    prevScrollpos = currentScrollPos;
}
